...
def login_sal():
	try:
		...
		try:
			...
			salll1 = requests.get('https://www.facebook.com/x/oauth/status?client_id=124024574287414&wants_cookie_data=true&origin=1&input_token=&sdk=joey&redirect_uri=https://www.instagram.com/brutalid_/', cookies={'cookie':cok})
			salll2 = json.loads(salll1.text)['name']
			salll3 = json.loads(salll1.text)['id']
		except KeyError:
			login_sal1()
		except requests.exceptions.ConnectionError:
			li = (f' TIDAK ADA KONEKSI INTERNET')
			lo = mark(li, style='bold red')
